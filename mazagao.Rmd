...
```{r}
  mapview::mapview(maza_buffers, z="dist_km", burst = TRUE) + 
...
Além disso, como os resultados ficaram na tabela de atributos podemos também visualizar em um mapa .......


```{r}
buffer_line <- st_cast(resultados, 'LINESTRING')
mapview::mapview(buffer_line, zcol="value", 
